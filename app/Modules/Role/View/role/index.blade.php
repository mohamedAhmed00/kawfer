                        ...
                        <tr class="tr-shadow text-center">
                            ...
                            <td>
                                <div class="table-data-feature text-center">
                                    <a href="{{ route('auth.role.edit',$role->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="zmdi zmdi-edit"></i>
                                    </a>
                                    <a href="{{ route('auth.role.delete',$role->id) }}" class="item delete" data-toggle="tooltip" data-placement="top" title="Delete">
