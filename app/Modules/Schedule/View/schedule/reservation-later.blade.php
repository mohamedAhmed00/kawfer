...
@section('content-admin')
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">انشاء حجز و الكشف لاحقا</div>
            <div class="card-body">
                <form action="{{ route('auth.reservation.later.store') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>اختار اليوم : </label>
                        <input type="date" placeholder="اختار اليوم" name="operation_date" value="" width="312" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker" id="selectedOperation" name="operation_id" data-live-search="true">
                            ...
                            @foreach($operations as $operation)
                                <option data-tokens="{{ $operation->id }}"
