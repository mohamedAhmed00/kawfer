...
@section('content-admin')
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">{{ !empty($operation)? 'Edit Operation' . $operation->name : 'Create New Operation' }}</div>
            <div class="card-body">
                <form action="{{ !empty($operation)? route('auth.operation.update',$operation->id) : route('auth.operation.store') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="name" class="control-label mb-1">Operation Title</label>
                    ...
                    <div class="form-group">
                        <label for="price" class="control-label mb-1">Operation Price</label>
