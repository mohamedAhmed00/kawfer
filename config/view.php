...
return [
    ...
    */
    ...
    'paths' => [
        ...
        app_path('Modules/Invoice/View'),
        app_path('Modules/Client/View'),
        app_path('Modules/Schedule/View'),
        ...
        app_path('Modules/Report/View'),
        app_path('Modules/RolePermission/View'),
        app_path('Modules/Order/View'),
        app_path('Modules/Reservation/View'),
        app_path('Modules/Discount/View'),
